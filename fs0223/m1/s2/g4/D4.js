...
for (let ca of starWarsCharacters){
  if (ca.gender === "female"){
     femaleCharacters.push({
       name: ca.name,
       hair_color : ca.hair_color,
       eye: ca.eye_color
     });
}
}
...
/* ESERCIZIO 5
  ...
  */
  for (let prop in starWarsCharacters){
    ...
    switch(starWarsCharacters[prop].eye_color){
      case "blue" :
        eyeColor.blue.push(starWarsCharacters[prop]);
        break;
      case "yellow" :
        eyeColor.yellow.push(starWarsCharacters[prop]);
        break;
      case "brown" :
        eyeColor.brown.push(starWarsCharacters[prop]);
        break;
      case "red" :
        eyeColor.red.push(starWarsCharacters[prop]);
        break;
      case "blue-gray" :
        eyeColor.bluegray.push(starWarsCharacters[prop]);
        break;
    }
}
console.log(eyeColor)
